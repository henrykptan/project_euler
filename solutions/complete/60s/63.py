...
# clearly for any base number a greater than 10, a**b will be longer than b digits -->
# so we only need to test the numbers a = 1-9
...
if __name__ == '__main__':
    ...
    for i in range(1, 100):  # our exponent number
        ...
        for base in range(1, 10):  # our base number
            # we need to find the smallest base such that the claim holds, then we know it works up to 9
            # (10**n is exactly n+1 digits long)
            if len(str(base ** i)) == i:
                break
